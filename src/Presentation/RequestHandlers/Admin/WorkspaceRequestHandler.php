...
#[Route(path: '/workspaces/[uuid:id]', method: RequestMethod::GET)]
class WorkspaceRequestHandler extends AbstractAdminViewRequestHandler implements
    RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return new ViewResponse(
            ...
            ['current_workspace' => new WorkspaceResource($ws, ['user', 'subscription.order'])]
        );
    }
}
